...
class MainApp(QMainWindow, ui):
    def __init__(self):
        ...
        self.trainuser.clicked.connect(self.show_training_form)
        self.attendence.clicked.connect(self.show_attendence_form)
        self.reports.clicked.connect(self.show_reports_form)
        self.back.clicked.connect(self.show_mainform)
        self.goback.clicked.connect(self.show_mainform)
        self.go.clicked.connect(self.show_mainform)
        self.train.clicked.connect(self.start_training)
        self.entry.clicked.connect(self.record_attendance)
        self.dateEdit.setDate(date.today())
        self.dateEdit.dateChanged.connect(self.show_selected_date_reports_)
    ...
    def show_selected_date_reports_(self):
        self.REPORTS.setRowCount(0)
        self.REPORTS.clear()
        con = sqlite3.connect("face-reco.db")
